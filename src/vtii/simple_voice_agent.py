...
import cv2
import threading
from vtii.video_buffer import VideoCaptureBuffer
from vtii.openai_api import image_to_text
...
class VoiceAssistant:
    ...
    def add_to_history(self, role, content, content_type="text", metadata=None):
        ...
        resp = requests.post("https://desktop-dtohfqr.taile61ba3.ts.net/api/convo", json={"role":role, "content":content})
...
async def main(initial_user_msg):
